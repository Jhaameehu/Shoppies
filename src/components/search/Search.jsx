...
class Search extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      search: "", //stores the search term inputed by the user, default: little women
  ...
  render() {
    return (
      <div className='wrapper'>
        <div className="hero-body main" id="searchContainer">
                        ...
                        <div className="card-content">
                          <div className="media">
                            <div className="media-content has-text-centered">
                              ...
                              <button
                                className="button nominateButton is-warning is-light is-outlined"
        ...
        <div className="hero-foot sidebar">
